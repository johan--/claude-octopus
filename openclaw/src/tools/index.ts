...
export const SKILL_REGISTRY: SkillRegistryEntry[] = [
  ...
  { name: "skill-debug", description: "Systematic debugging workflow", type: "skill", file: "skill-debug.md" },
  ...
  { name: "octopus-research", description: "Deep research with multi-source synthesis", type: "skill", file: "skill-deep-research.md" },
  ...
  { name: "skill-factory", description: "Autonomous build pipeline", type: "skill", file: "skill-factory.md" },
